    ...
    <div class="navbar-collapse collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li>
                ...
                <ul class="dropdown">
                    <li><a href="<?php echo base_url(); ?>User/Register">ลงทะเบียน</a></li>
                    <li><a href="<?php echo base_url(); ?>User/Signin">เข้าสู่ระบบ</a></li>
                </ul>
            </li>
        </ul>
        <!-- End Navigation List -->
...
<ul class="wpb-mobile-menu">
    ...
    <li>
        <a id="nav-bar-member" href="User">ผู้ใช้งาน</a>
        <ul class="dropdown">
            <li><a href="<?php echo base_url(); ?>User/Register">ลงทะเบียน</a></li>
            <li><a href="<?php echo base_url(); ?>User/Signin">เข้าสู่ระบบ</a></li>
        </ul>
